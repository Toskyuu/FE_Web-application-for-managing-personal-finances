    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="Zarządzaj swoimi kontami finansami z aplikacją YourFinance."/>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="flex items-center gap-4">
                            ...
                            <p className="text-justify"><span
                                className="text-secondary">Zarządzanie kontami bankowymi</span> – śledź swoje salda i
                                transakcje.</p>
                        </div>
                        <div className="flex items-center gap-4">
                            <span className=" text-4xl">📊</span>
                            <p className="text-justify"><span className="text-secondary">Statystyki i analizy</span> –
                                wizualizuj swoje wydatki i dochody.</p>
                        </div>
                        <div className="flex items-center gap-4">
                            <span className=" text-4xl">🎯</span>
                            <p className="text-justify"><span className="text-secondary">Budżetowanie</span> – ustaw
                                limity wydatków dla wybranych kategorii.</p>
                        </div>
                        <div className="flex items-center gap-4">
                            <span className=" text-4xl">🌍</span>
                            <p className="text-justify"><span className="text-secondary">Dostępność</span> – korzystaj z
                                aplikacji na komputerze i urządzeniach
                                mobilnych.</p>
                        </div>
                    </div>
                </MainCard>
                ...
                <MainCard fontSize="text-lg" padding="p-6" height="h-auto" width="w-full">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-4">
                            ...
                            <p className="text-justify"><strong className="text-secondary">Załóż
                                konto:</strong> Zarejestruj
