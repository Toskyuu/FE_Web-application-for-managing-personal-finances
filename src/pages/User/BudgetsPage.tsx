...
const BudgetsPage: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Budżety | YourFinance</title>
                <meta name="description" content="Twórz i zarządzaj swoimi budżetami."/>
                <link rel="canonical" href="http://localhost:4173/budgets"/>
            </Helmet>
            <div className="p-4 space-y-6 max-w-[1800px] justify-center mx-auto">
                ...
                <div
                    className="flex justify-between items-center w-full lg:w-1/2 sm:w-3/4 mx-auto flex-wrap gap-3 h-full">
                    ...
                    <div className="flex justify-end items-center w-auto flex-wrap gap-3">
                        <select
                            id="sort-by"
                            value={sortBy}
                            aria-label="Wartość, po której będą sortowane budżety"
                            onChange={(e) => {
