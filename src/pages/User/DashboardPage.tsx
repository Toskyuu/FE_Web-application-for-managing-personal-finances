                        ...
                        <div className="grid xl:grid-cols-7 md:grid-cols-4 grid-cols-1 gap-6">
                                ...
                                <MainCard fontSize="text-lg" padding="" height="h-full" width="w-auto">
                                    ...
                                    <div className=" flex flex-col flex-1 h-full">
                                        ...
                                        {data.budgets.budgets.length <= 0 ?
                                            ...
                                            (
                                                <>
                                                    <div className="scrollbar-custom max-h-full overflow-y-auto p-5">
                                                                            ...
                                                                            className={`${
                                                                                budget.spent_to_limit_ratio > 100
                                                                                    ...
                                                                                    : budget.spent_to_limit_ratio > 80
                                                                                        ? 'bg-senary'
                                                                                        : 'bg-success'
                                                                            } h-4 rounded-full`}                                                                            style={{width: `${Math.min(budget.spent_to_limit_ratio, 100)}%`}}
                                                                        ></div>
                                                                    </div>
                                                    ...
                                                    {data.budgets.budgets.length >= 6 && (
                                                        <div className="relative bottom-0 w-full ">
                                                            <button
                                                                className="w-full h-10 border-t-2 rounded-b-2xl duration-300  text-center dark:bg-surface-dark bg-surface-light hover:brightness-75 "
                                                                aria-label="Zobacz wszystkie budżety"
                                                                onClick={() => {
                                                                    navigate("/budgets");
                                                                }}
                                                            >
                            ...
                            <div
                                ...
                                <MainCard fontSize="text-lg" padding="" height="h-full" width="w-auto">
                                    <div
                                        className="text-text-dark relative top-0 w-full h-10 bg-secondary rounded-t-2xl flex items-center pl-5 text-left border-b-2 dark:border-background-light border-background-dark">
                                        <div className="text-xl">Konta</div>
                                    </div>
                                    <div className=" flex flex-col flex-1 h-full ">
                                        {data.accounts.accounts.length <= 0 ? (
                                            <div>Nie posiadasz żadnych kont.</div>
                                        ) : (
                                            <>
                                                <div className="scrollbar-custom max-h-full overflow-y-auto p-5">
                                                ...
                                                {data.accounts.accounts.length >= 5 && (
                                                    <div className="relative bottom-0 w-full ">
                                                        <button
                                                            className="w-full h-10 border-t-2 rounded-b-2xl duration-300  text-center dark:bg-surface-dark bg-surface-light hover:brightness-75 "
                                                            aria-label="Zobacz wszystkie konta"
                                                            onClick={() => {
                                                                navigate("/accounts");
                                                            }}
                                                        >
                                        ...
                                        {data.transactions.transactions.length <= 0 ?
                                            ...
                                            (
                                                <>
                                                    ...
                                                    {data.transactions.transactions.length >= 5 && (
                                                        <div className="relative bottom-0 w-full ">
                                                            <button
                                                                className="w-full h-10 border-t-2 rounded-b-2xl duration-300  text-center dark:bg-surface-dark bg-surface-light hover:brightness-75 "
                                                                aria-label="Zobacz wszystkie transakcje"
                                                                onClick={() => {
